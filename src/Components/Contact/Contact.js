  ...
  return (
    <div>
      ...
      <div className="contectSection">
        <div className="contactInformation">
         ...
         <div className="flex justify-start items-center mt-5">
          ...
          <div className="flex justify-start items-center mt-5">
            ...
            <h1 className="text-white ms-4 text-3xl">hello@carlonimortgages.com</h1>
          </div>
          <div className="flex justify-start items-center mt-5">
            <img src={location} alt=""></img>
            <h1 className="text-white ms-4 text-3xl">366 Main St, Penticton, BC</h1>
          </div>
         </div>
        ...
        <iframe
          className="contactMap  mx-auto my-16 "
